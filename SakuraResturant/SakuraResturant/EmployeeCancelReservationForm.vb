...
Public Class EmployeeCancelReservationForm
    ...
    Private Sub EmployeeCancelReservationForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ReservationAccess.ExecuteQuery("SELECT r.reservationID AS 'Reservation ID', c.firstName AS 'Customer First Name',
                                        ...
                                        JOIN discount AS d ON d.discountID = r.discountID WHERE r.reservationStatus = 'Reserved'")
    ...
    Private Sub ReservationsDataGridView_CelldoubleClick(sender As Object,
        ...
        'Refresh the grid
        EmployeeCancelReservationForm_Load(sender, e)
