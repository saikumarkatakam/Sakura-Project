...
Partial Public Class EmployeeDataSet
    ...
    Partial Public Class EmployeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEmployeeRow(ByVal employeeID As UInteger, ByVal firstName As String, ByVal reservationID As UInteger) As EmployeeRow
            Dim rowEmployeeRow As EmployeeRow = CType(Me.NewRow,EmployeeRow)
            Dim columnValuesArray() As Object = New Object() {employeeID, firstName, reservationID}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByemployeeIDreservationID(ByVal employeeID As UInteger, ByVal reservationID As UInteger) As EmployeeRow
            Return CType(Me.Rows.Find(New Object() {employeeID, reservationID}),EmployeeRow)
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Sub InitClass()
            Me.columnemployeeID = New Global.System.Data.DataColumn("employeeID", GetType(UInteger), Nothing, Global.System.Data.MappingType.Element)
            ...
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnemployeeID, Me.columnreservationID}, true))
    ...
    Partial Public Class EmployeeRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Property employeeID() As UInteger
            Get
                Return CType(Me(Me.tableEmployee.employeeIDColumn),UInteger)
            End Get
            Set
        ...
        Public Property reservationID() As UInteger
            Get
                Return CType(Me(Me.tableEmployee.reservationIDColumn),UInteger)
            End Get
            Set
                Me(Me.tableEmployee.reservationIDColumn) = value
            End Set
        End Property
    End Class
...
Namespace EmployeeDataSetTableAdapters
    ...
    Partial Public Class EmployeeTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT employee.employeeID,employee.firstName,reservation.reservationID FROM empl"& _ 
                "oyee JOIN reservation ON reservation.employeeID = employee.employeeID"
